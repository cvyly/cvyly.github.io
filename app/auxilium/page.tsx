...
import { subscribeToMapEntities } from "@/lib/ably"
...
export default function AuxiliumPage() {
  ...
  useEffect(() => {
    const unsubscribe = subscribeToMapEntities(selectedMap, (nextEntities) => {
  ...
  useEffect(() => {
    ...
    const nextSelectedEntity = entities.find((entity) => entity.id === selectedEntity.id)
